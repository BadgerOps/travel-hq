...
const createPersonSchema = z.object({
  ...
  driverLicenseExpiry: calendarDateSchema.optional(),
  driverLicenseJurisdiction: z.string().optional(),
...
const updatePersonSchema = z
  .object({
    ...
    driverLicenseNumber: z.string().min(1).nullable().optional(),
    driverLicenseExpiry: calendarDateSchema.nullable().optional(),
    driverLicenseJurisdiction: z.string().nullable().optional(),
