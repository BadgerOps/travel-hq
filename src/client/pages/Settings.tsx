...
import { Eye, FloppyDisk, Flask, Info, Key, Robot, Trash } from "@phosphor-icons/react";
...
import { HouseholdMembers } from "../household/HouseholdMembers.js";
...
export function Settings({ api = defaultApi }: { api?: typeof defaultApi }) {
  ...
  // /api/settings and lands here. This page is now entirely about the
  // household, so there is genuinely nothing on it for them; what they came
  // for is on /me, and saying where is the difference between a dead end and a
  // signpost.
  if (forbidden) {
    return (
      <>
        ...
        <div className="settings-main">
          <div className="card" style={{ maxWidth: 560, alignItems: "flex-start", gap: 10 }}>
            ...
            <p className="card-body" style={{ margin: 0 }}>
              Household settings control who is in this household and whose email can write
              into it, so viewing and editing them is limited to owners and admins.
            </p>
            <p className="card-body" style={{ margin: 0 }}>
              Your own details, documents and notification settings are yours whatever your
              role — they live on your profile page.
            </p>
          </div>
        </div>
    ...
    <>
      ...
      {settings !== null && (
        <div className="split-main-rail">
          <div className="settings-main">
            {/* First, deliberately, and it is where /people used to be: who is
                in the household precedes every other question this page asks,
                including whose mail may write into it. */}
            <HouseholdMembers api={api} />
